  ...
  <div class="form-group form-group-lg {{ ($errors->first('price'))?'has-error':'' }}">
    <label class="control-label" for="price">preu</label>
    <input type="number" class="form-control" name="price" id="price" placeholder="preu" value="{{ $incentive->price?:'' }}" />
