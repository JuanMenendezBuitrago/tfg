  ...
  <div class="form-group form-group-lg {{ ($errors->first('name')) ? 'has-error'  :''}}">
    ...
    <input type="text" class="form-control" name="name" id="name" placeholder="nom" value="{{ $activity->name?:'' }}" />
  ...
  <div class="form-group form-group-lg {{ ($errors->first('description')) ? 'has-error'  :''}}">
    ...
    <textarea class="form-control" name="description" id="description" placeholder="descripció">{{ $activity->description?:'' }}</textarea>
