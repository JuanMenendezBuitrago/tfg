...
return [
    ...
    */
    ...
    "boolean"          => ":attribute ha de ser verdader o fals", 
    ...
    "dimensions"       => ":attribute té dimensions d'imatge no vàlids.",
    ...
    "json"             => ":attribute ha de ser un JSON valid",
    "max"              => array(
    ...
    "present"          => ":attribute ha de estar present.",
    ...
    "required_without_all" => "El camp :attribute és obligatori quan ningú del :values és present.",
    ...
    "string"           => ":attribute ha ser una cadena de text.",
    "timezone"           => ":attribute ha de ser una zona valida.",
    ...
    */
    'attributes' => [
        ...
        'name'          => 'nom',
        'price'         => 'price',
        'readable_name' => 'nom llegible',
        'semester'      => 'semestre',
        'school'        => 'escola/facultat',
        'user'          => 'usuari',
        'year'          => 'any',
    ],
];